...
public class UploadNotificationConfig implements Parcelable {
    ...
    public UploadNotificationConfig(Context context) {
        iconResourceID = android.R.drawable.ic_menu_upload;

        Resources r = context.getResources();
        title = r.getString(R.string.notif_file_upload);
        message =  r.getString(R.string.notif_file_upload_in_progress);
        completed =  r.getString(R.string.notif_file_upload_complete);
        error =  r.getString(R.string.notif_file_upload_error);
